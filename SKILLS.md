...
- **Export to CSV/PNG** from chart components
...
- Whitelist for public endpoints (health, login, register)
...
### 5.1 Backend Testing
- **pytest** with async support for FastAPI endpoints
...
- **PR templates** with checklist for review
